...
**Total: 10 subagents (3 shipped, 7 to build).**
...
| 5 | `fundamentals-fetcher` | Planned | `fundamentals.yaml`, `valuation.yaml` | `internal/agents/fundamentals-fetcher.md` (to create) |
