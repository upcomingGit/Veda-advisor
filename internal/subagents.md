...
**Total: 11 subagents (7 shipped, 4 to build).** All 11 are gating dependencies for the Tier 1.5 Python orchestrator — see [ROADMAP.md](../ROADMAP.md) Tier 1.
